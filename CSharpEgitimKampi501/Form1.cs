...
namespace CSharpEgitimKampi501
{
    public partial class Form1 : Form
    {
        ...
        SqlConnection connection = new SqlConnection("Server=XNCOOL;initial Catalog=EgitimKampi501Db;integrated security=true");
        ...
        private void lblTotalProductCount_Click(object sender, EventArgs e)
        {
